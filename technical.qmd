...
Visual mode included extensive support for Pandoc features frequently used in technical writing including [equations](#equations), [citations](citations.qmd), [cross-references](#cross-references), [footnotes](#footnotes), [embedded code](#embedded-code), and [LaTeX](#latex-and-html).
...
![](images/visual-editing-xref.png)
...
![](images/visual-editing-xref-navigate.png)

You can also navigate directly to any cross-reference using IDE global search:

![](images/visual-editing-xref-search.png){.illustration}
