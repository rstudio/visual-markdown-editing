...
Visual markdown editing is currently only available in the daily build of RStudio (v1.4.314 or later). You can download the most recent daily build here: <https://dailies.rstudio.com>.
...
+----------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------+
| **Empty Item\                                                                          | **Tab**\                                                                                  | **Backspace**\                                                                          |
| ***enter to exit list*                                                                 | *add sublist to previous item*                                                            | *add block to previous item*                                                            |
+----------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------+
| ![](images/visual-editing-list-item.png){.illustration .list-illustration width="211"} | ![](images/visual-editing-list-sublist.png){.illustration .list-illustration width="211"} | ![](images/visual-editing-list-block.png){.illustration .list-illustration width="211"} |
+----------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------+
...
| Nested YAML          | YAML blocks within lists | Ignored (and dropped from document).     |
