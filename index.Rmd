...
![](images/visual-editing-table-context.png){width="700"}
...
<table><tbody><tr class="odd"><td><p><strong>Empty Item<br />
</strong><em>enter to exit list</em></p></td><td><p><strong>Tab</strong><br />
<em>add sublist to previous item</em></p></td><td><p><strong>Backspace</strong><br />
<em>add block to previous item</em></p></td></tr><tr class="even"><td><p><img src="images/visual-editing-list-item.png" class="illustration list-illustration" width="211" /></p></td><td><p><img src="images/visual-editing-list-sublist.png" class="illustration list-illustration" width="211" /></p></td><td><p><img src="images/visual-editing-list-block.png" class="illustration list-illustration" width="211" /></p></td></tr></tbody></table>
...
![](images/visual-editing-execute-code.png){width="700"}
