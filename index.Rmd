...
Visual markdown editing is currently only available in the daily build of RStudio (v1.4.297 or later). You can download the most recent daily build here: <https://dailies.rstudio.com>.
