...
Visual markdown editing is currently only available in the daily build of RStudio (v`r version` or later). You can download the desktop version of the daily build here:
