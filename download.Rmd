...
Visual markdown editing is currently only available in the daily build of RStudio (v`r params$version` or later). You can download the desktop version of the daily build here:
...
download_info <- lapply(platforms, function(platform) {
   platform$file <- sprintf(platform$file, params$version)
